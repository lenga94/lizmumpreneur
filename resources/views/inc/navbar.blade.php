    ...
    <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
            <p class="centered profile-pic">
                    @if(Auth::user()->personalInformation->profile_image != null)
                        <img id="userImage" src="{{ asset('storage/profile_images/'. Auth::user()->personalInformation->profile_image) }}" class="img-circle" width="80">
                    @else
                        <img id="userImage" src="{{ asset('images/no_image.jpg') }}" class="img-circle" width="80">
                    @endif
                </a>
            </p>
            <h5 class="centered">{{ Auth::user()->personalInformation->first_name }} {{ Auth::user()->personalInformation->last_name }}</h5>
            <li class="mt">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li id="manage_users"><a href="{{ route('manageUsersPage') }}"><i class="glyphicon glyphicon-edit"></i> Manage Users</a></li>
                </ul>
            </li>
           ...
           <li class="sub-menu">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li id="add_host_organisation"><a href="#"><i class="glyphicon glyphicon-plus-sign"></i> Add Organisation</a></li>
                    <li id="manage_host_organisations"> <a href="#"><i class="glyphicon glyphicon-edit"></i> Manage Organisations</a></li>
                    <li id="manage_host_organisations"> <a href="#"><i class="fa fa-briefcase"></i> USAID Projects</a></li>
                    <li id="manage_host_organisations"> <a href="#"><i class="fa fa-search-plus"></i> Intern Requests</a></li>
                </ul>
            </li>
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li id="manage_interns"> <a href="#"><i class="glyphicon glyphicon-edit"></i> Manage Interns</a></li>
                </ul>
            </li>
